# Expanded Multiverse Translation Project

## Link to the latest nightly translation

Download from [HERE](https://github.com/ftl-mv-translation/expanded-multiverse/releases/latest). (Updated every UTC 00:00)
...
1. Unzip the latest EMV into src-en/ directory
